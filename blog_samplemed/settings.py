...
MIDDLEWARE = [
    ...
    'apps.api.middleware.JSON404Middleware',
]
...
WSGI_APPLICATION = 'blog_samplemed.wsgi.application'
...
# Error handlers
HANDLER404 = 'apps.api.handlers.handler404'
HANDLER500 = 'apps.api.handlers.handler500'
...
SWAGGER_SETTINGS = {
    ...
    'JSON_EDITOR': True,
    'DEFAULT_INFO': 'blog_samplemed.urls.api_info',
}
